...
# v 0.2
"""
<plugin key="AirHumidifierTest" name="AirHumidifierTest" author="DCRM" version="0.2" wikilink="https://github.com/rytilahti/python-miio" externallink="https://github.com/develop-dvs/domoticz-AirHumidifier2">
    <params>
